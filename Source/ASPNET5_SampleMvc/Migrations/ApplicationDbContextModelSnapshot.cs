...
using ASPNET5_SampleMvc.Models;

namespace ASPNET5_SampleMvc.Migrations
{
    [ContextType(typeof(ASPNET5_SampleMvc.Models.ApplicationDbContext))]
    public class ApplicationDbContextModelSnapshot : ModelSnapshot
    {
        public override IModel Model
        {
            get
            {
                ...
                builder.Entity("ASPNET5_SampleMvc.Models.ApplicationUser", b =>
                {
                ...
                builder.Entity("Microsoft.AspNet.Identity.IdentityUserClaim`1[[System.String, mscorlib, Version=4.0.0.0, Culture=neutral, PublicKeyToken=b77a5c561934e089]]", b =>
                {
                    b.ForeignKey("ASPNET5_SampleMvc.Models.ApplicationUser", "UserId");
                });
